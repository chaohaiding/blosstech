...
oPaginate:{sFirst:"First",sLast:"Last",sNext:"下一页",sPrevious:"前一页"},sEmptyTable:"No data available in table",sInfo:"显示 _START_ 到 _END_ 共计 _TOTAL_ 条信息",sInfoEmpty:"显示 0 到 0 共有 0 信息",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"显示 _MENU_ 信息",sLoadingRecords:"读取中...",sProcessing:"Processing...",sSearch:"搜索:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"没有找到匹配的信息"},oSearch:h.extend({},
